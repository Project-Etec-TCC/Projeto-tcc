        ...
        <div class="col-sm-4 offset-sm-4 bg-info">
            ...
            <form action="" method="">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="mail" name="recuperaEmail" class="form-control" placeholder="Digite seu E-mail" aria-label="E-mail" aria-describedby="basic-addon1" required>
                </div>
                ...
                <p>
                    <a href="login.php" class="text-danger">Fazer login</a>
                </p>
